...
First level: Вести изменения в проект с реализацией игры так, чтобы два различных
 класса игроков имплементировали интерфейс, в котором будет объявлен метод, предназначенный
 для нанесения удара по сопернику. В завимости от типа игрока реализация будет различной.
